...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-every", type=int, default=None, help="Save a checkpoint every N iterations (after merge for parallel).")
    parser.add_argument("--checkpoint-dir", type=str, default="poker_cfr/data/checkpoints", help="Directory to store checkpoints.")
    parser.add_argument("--checkpoint-prefix", type=str, default="strategy_ckpt", help="Filename prefix for checkpoints.")
